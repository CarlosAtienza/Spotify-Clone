...
const AlbumPage = () => {
    ...
    const handlePlayAlbum = () => {
        if (!currAlbum) return;
        const isCurrAlbumPlaying = currAlbum?.songs.some(song=>song._id === currSong?._id);
                            ...
                            <img src={currAlbum?.imageUrl} alt={currAlbum?.title}
                                ...
                                <div className="px-6 pb-4 flex items-center gap-6">
                                    <Button
                                        ...
                                        {isPlaying && currAlbum?.songs.some((song) => song._id === currSong?._id) ? (
                                    ...
                                    <div className="space-y-2 py-4">
                                        {currAlbum?.songs.map((song,index) => {
                                            ...
                                            <div className="flex items-center gap-3">
                                                <img src={currAlbum.imageUrl} alt={song.title} className="size-10"/>
                                            <div>
                                               {isCurrSong ? (
